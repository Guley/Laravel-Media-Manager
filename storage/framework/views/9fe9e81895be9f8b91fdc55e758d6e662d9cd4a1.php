<link href="<?php echo e(asset('assets/css/components.min.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('assets/css/core.min.css')); ?>" rel="stylesheet">
...
<script>
    ...
    function refreshImageList() {
        ...
        $.ajax({
            ...
            url: "<?php echo e($base_url); ?>media/getimages?page="+ page + search_string,
            dataType: 'json',
            type: 'get',
    ...
    $(function(){
        ...
        $(".file-input-ajax").fileinput({
            uploadUrl: "<?php echo e($base_url); ?>media/uploadimages?m=<?php echo e($module); ?>", // server upload action
            uploadAsync: true,
...
</script><?php /**PATH /home/gulshan/htdocs/laravel/media-manager/resources/views/admin/media/gallery-inline-js.blade.php ENDPATH**/ ?>